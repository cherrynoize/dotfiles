...
#     show-pokemon
  ...
  abbr --position anywhere -- -media '/home/shared/media'
  abbr --position anywhere -- -movies '/home/shared/media/movies'
  abbr --position anywhere -- -anime '/home/shared/media/anime'
  abbr --position anywhere -- -manga '/home/shared/media/manga'
  abbr --position anywhere -- -music-downloads '/home/shared/media/music'
  abbr --position anywhere -- -music '/home/shared/art/audio/music'
  abbr --position anywhere -- -music-projects '/home/art/personal/audio/music/projects'
  abbr --position anywhere -- -lyrics '/home/shared/notes/music/lyrics'
  ...
  abbr --set-cursor timer 'timer (math "%") -n; alert'
  ...
  abbr destroy 'kill -9'
  abbr rs 'time rs'
  abbr --command sudo rs 'time rs'
  abbr --command sd rs 'time rs'
  abbr transfer 'time rs -aPhv --info=progress2 --hard-links --ignore-existing # no-clobber cp'
  abbr stransfer 'time sd rs -aPhv --info=progress2 --hard-links --ignore-existing # no-clobber cp'
  abbr backup --set-cursor 'time rs -aPhv --info=progress2 --hard-links --update % # overwrites older files on dest only'
  abbr sbackup --set-cursor 'time sd rs -aPhv --info=progress2 --hard-links --update % # overwrites older files on dest only'
  abbr rclone 'rclone --password-command "pass show cloud/rclone" -P'
  abbr u 'unlock && vcs-sync'
