...
#     show-pokemon
  ...
  abbr transfer 'time rs -aPhv --info=progress2 --hard-links --ignore-existing'
  abbr stransfer 'time sd rs -aPhv --info=progress2 --hard-links --ignore-existing'
  abbr backup --set-cursor 'time rs -aPhv --info=progress2 --hard-links --update % # overwrites files older on dest'
  abbr sbackup --set-cursor 'time sd rs -aPhv --info=progress2 --hard-links --update % # overwrites files older on dest'
